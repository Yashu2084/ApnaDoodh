import { DeliveryItem, getDeliveries, addDelivery, updateDeliveryStatus, pauseCustomerDeliveries, skipDeliveryDate } from "../db";
...
export class DeliveryRepository {
  ...
  async logTemperature(id: string, temperature: number): Promise<DeliveryItem> {
    const { logDeliveryTemperature } = await import("../db");
