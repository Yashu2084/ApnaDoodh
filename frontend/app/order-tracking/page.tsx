...
export default function OrderTrackingPage() {
  ...
  return (
    <div className="relative w-full overflow-hidden px-4 sm:px-6 lg:px-8 pt-28 pb-16 sm:pt-36 sm:pb-24 flex items-center justify-center min-h-[calc(100vh-80px)]">
