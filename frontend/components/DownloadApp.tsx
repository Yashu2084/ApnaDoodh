...
export default function DownloadApp() {
  ...
  return (
    <section className="relative w-full overflow-hidden flex items-center justify-center min-h-[80vh] py-14 sm:py-24 px-4 sm:px-8 lg:px-12 scroll-mt-24">
      ...
      <div className="relative z-10 w-full max-w-6xl rounded-[3rem] border border-white/60 bg-white/80 p-8 sm:p-12 lg:p-16 shadow-[0_32px_96px_-24px_rgba(15,23,42,0.12)] backdrop-blur-xl overflow-hidden">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center relative">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full bg-blue-100/60 px-4 py-1.5 text-[10px] font-bold text-blue-700 uppercase tracking-widest border border-blue-200/20 shadow-xs">
            ...
            <div className="space-y-3.5 pt-2">
              {features.map((feat, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-blue-50 text-blue-600 mt-0.5 border border-blue-100/40 shadow-inner">
                    <CheckCircle2 className="h-3 w-3" />
                  </span>
                  <div>
                    <h3 className="text-xs font-bold text-slate-900 leading-tight">{feat.title}</h3>
                    <p className="text-[10px] text-slate-500 font-medium mt-1 leading-normal text-justify">{feat.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          >
            <motion.div
              ...
              className="relative w-68 h-[500px] rounded-[3rem] bg-slate-950 p-2.5 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.25)] overflow-visible flex flex-col justify-between border-[10px] border-slate-900"
            >
              ...
              <div className="w-full h-full rounded-[2.3rem] bg-slate-50 border border-slate-900/5 p-3.5 pt-7.5 flex flex-col justify-between select-none relative z-10 overflow-hidden">
                ...
                <div className="flex items-center justify-between border-b border-slate-100/60 pb-2 mt-1">
                ...
                <div className="mt-2 rounded-lg bg-white border border-slate-100/60 p-1.5 flex items-center gap-1.5 shadow-sm">
                ...
                <div className="flex-grow py-2 space-y-2 overflow-hidden">
                  ...
                  <div className="text-left">
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-1">
                      {[
                        ...
                        <div key={i} className="rounded-xl border border-slate-100/60 bg-white p-2 text-left flex flex-col justify-between shadow-sm hover:border-blue-100 transition">
                          <div>
                  ...
                  <div className="rounded-xl border border-emerald-100 bg-emerald-50/50 p-2 flex items-center justify-between text-left shadow-sm">
                    <div>
                ...
                <div className="border-t border-slate-100/60 pt-2 flex items-center justify-around">
                  {[
